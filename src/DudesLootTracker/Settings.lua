...
local function createOptionsPanel()
    ...
    table.insert(optionsPanel.controls, c)
    c = createCheckbox(content, c, -8, "Beute-Fenster öffnen bei neuer Elite-Beute", function() return ADDON.GetSettings().autoOpenOnEliteLoot end, function(value) ADDON.GetSettings().autoOpenOnEliteLoot = value end)
    table.insert(optionsPanel.controls, c)
